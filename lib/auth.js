...
//'logIn' -> Middleware to compare password from login form with password from the user
// in the database. If matches (hopefully), the user ID is stored in the session
