...
// Create a new user by handling the POST request from a form with action  '/users'
...
// It redirects to /login when attemped to be reached by a non logged in user
// It is "protected" by the authenitcate middleware from the auth library
